...
If it didn't work follow the link:https://github.com/quarkusio/quarkus/blob/main/CONTRIBUTING.md#setup[CONTRIBUTING - Setup] page to setup your environment, anyway at some point you may need to read this page!
...
You can read the link:https://github.com/quarkusio/quarkus/blob/main/CONTRIBUTING.md[CONTRIBUTING] page for general guidelines, if you don't understand everything don't panic ;), or you can refer to it if needed as it can be hard to read for newcomers.
...
Or just tell us your story with Quarkus, we love to hear user stories, and have a link:https://github.com/quarkusio/quarkus/blob/main/ADOPTERS.md[dedicated page],
...
When you're decided to work on something, you can find help on Zulip or Github by pinging area link:https://github.com/quarkusio/quarkus/blob/main/MAINTAINERS.adoc[maintainers].
